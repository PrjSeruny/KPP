...
$upload_dir = '/simas/images/piclib'; // path from base_url to upload base dir
$current_path = '../../../../images/piclib'; // relative path from filemanager folder to upload files folder
