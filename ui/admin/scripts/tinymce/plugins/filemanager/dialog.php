...
if(isset($_GET['subfolder']) && !empty($_GET['subfolder'])) {
    ...
    /*echo "aaa".$cur_dir."<br>";
    echo "aaa".$cur_path."<br>";
    echo "aaa".$thumbs_path."<br>";*/
}
else {
    $cur_dir = $upload_dir . (!empty($subdir)?"/".$subdir:"/");
    $cur_path = $current_path . (!empty($subdir)?"/".$subdir:"/");
    $thumbs_path = 'thumbs/';
    /*echo "bbb".$cur_dir."<br>";
    echo "bbb".$cur_path."<br>";
    echo "bbb".$thumbs_path."<br>";*/
}
