...
<fieldset class="wrapper">
  <div class="form" style="clear:left">
    <h2 class="title">Daftar Data Mutasi KK</h2>
    <form method="post"  class="ajax-form" dst="birthlist" id="birthlist" 
    action="<%=Constants.ROOT_PATH%><%=TransConstants.SVT_TRANS_PATH%>?<%=TransConstants.W%>=<%=TransConstants.TRANS_FAMILYCARDMUT%>">
      <jsp:include page="<%=TransConstants.PAGE_FAMILYCARDMUT_LIST%>" flush="true"/>
    </form>
  </div>
</fieldset>
